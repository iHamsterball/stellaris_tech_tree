...
NDefines = {
	...
	NGameplay = {
		...
		ALLIANCE_INFLUENCE_COST  			= 1,	-- For being in an alliance
	...
	NAI = {
		...
		ALLIANCE_BREAK_THRESHOLD = -60,		-- If AI values an existing alliance at less than this, leave it
		...
		TRADE_VALUE_STRATEGIC_RESOURCE = 0.1, -- for 1 strategic resource (per year)
