...
NDefines = {
	...
	NAI = {
		...
		DEFENSIVE_PACT_ACCEPTANCE_NUM_PACTS = -10,	-- per existing defensive pact
		...
		SECTOR_BUILDING_BUDGET_FRACTION = 0.45, -- Fraction of budget going to buildings
		...
		SECTOR_STATION_MAINT_BUDGET_FRACTION = 0.45,-- Fraction of maintenance budget going to spaceports and stations
